...
# Validation scripts spin up real AnomalyClassifierAgent instances wired to
# a live bus/RCA. Their genuine EXECUTED resolutions would otherwise be
...
# feedback with validation-run data. Redirect it to a scratch file; every
# validate_*.py imports this module before running its checks.
try:
    ...
    _scratch_feedback_path = Path(tempfile.gettempdir()) / "armor_validation_aca_feedback.jsonl"
