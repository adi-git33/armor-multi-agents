  ...
  const metricRows = [
    {
      ...
      info: "Confirmed threats / (confirmed threats + false positives) classified by ACA so far this run.",
    },
    {
      label: "FALSE POSITIVE",
      value: `${(metrics.fpr * 100).toFixed(1)} %`,
      color: metrics.fpr < 0.08 ? C.green : C.amber,
      info: "Share of ACA's threat classifications that were not corroborated as real threats.",
    },
    {
      label: "MTTR",
